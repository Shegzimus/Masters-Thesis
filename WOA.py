...
class BaseWOA2(RootAlgo):
    ...
    def _train__(self):
        ...
        for i in range(self.epoch):
            ...
            #a = 1.5 + np.sin(i * np.pi / self.epoch)    # Sinusoidal variation 1
            #a = 2 + np.sin(2 * np.pi * i / self.epoch)  # Sinusoidal variation 2
